...
-- Looking at each customer's monthly balance by calculating: averge, minimum, maximum, and sum
...
-- Creainig a rank of outstanding debt
...
-- Joining tables and looking at each customer's monthly pay after deducting (EMI + intrest)
